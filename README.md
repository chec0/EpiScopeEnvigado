...
│                         episcopeenvigado and configuration for tools like black
│
...
│
└── episcopeenvigado   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes episcopeenvigado a Python module
    │
